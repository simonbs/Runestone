...
public protocol EditorTextInputViewDelegate: AnyObject {
    ...
    func editorTextInputView(_ view: EditorTextInputView, didInvalidateContentSize newContentSize: CGSize)
}

public extension EditorTextInputViewDelegate {
    func editorTextInputViewDidChange(_ view: EditorTextInputView) {}
}

public final class EditorTextInputView: UIView, UITextInput {
    public weak var editorDelegate: EditorTextInputViewDelegate?
    ...
    public var viewport: CGRect {
        get {
            return textView.viewport
        }
        set {
            inputDelegate?.selectionWillChange(self)
            textView.viewport = newValue
            inputDelegate?.selectionDidChange(self)
        }
    }
    ...
    public override func becomeFirstResponder() -> Bool {
        ...
        if !wasFirstResponder && isFirstResponder {
            ...
            editorDelegate?.editorTextInputViewDidBeginEditing(self)
        }
...
// MARK: - Caret
public extension EditorTextInputView {
...
public extension EditorTextInputView {
    func insertText(_ text: String) {
        ...
        editorDelegate?.editorTextInputViewDidChange(self)
    }
...
extension EditorTextInputView: EditorBackingViewDelegate {
    func editorBackingViewDidInvalidateContentSize(_ view: EditorBackingView) {
        editorDelegate?.editorTextInputView(self, didInvalidateContentSize: view.contentSize)
    }
}
