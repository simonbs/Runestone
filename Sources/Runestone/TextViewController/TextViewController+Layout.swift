...
//        let xPosition = gutterWidthService.gutterWidth + textContainerInset.left + PageGuideLayouter.columnOffset
...
//        PageGuideLayouter.guideView.frame = CGRect(origin: origin, size: pageGuideSize)
    }
}
