...
//public final class TextViewState<LineManagerType: LineManaging> {
...
//    static func makeLineManager(stringView: StringView, theme: Theme) -> LineManagerType {
//        let lineManager = RedBlackTreeLineManager()
//        lineManager.estimatedLineHeight = theme.font.actualLineHeight
////        lineManager.rebuild()
//        return lineManager
//    }
//
//    static func detectIndentStrategy(
//        string: NSString,
//        lineManager: LineManagerType,
//        tree: TreeSitterTree?
