...
final class TextLayouter<LineManagerType: LineManaging>: TextLayouting {
    private let viewport: Viewport
    private let lineManager: LineManagerType
    private var visibleLineIDs: Set<UUID> = []
    private let lineFragmentViews = ReusableViewQueue<UUID, LineFragmentView>()

    init(viewport: Viewport, lineManager: LineManagerType) {
...
//        }
    ...
    func layoutText(toLocation location: Int) {}
}
