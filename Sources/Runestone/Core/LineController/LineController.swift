...
//            let lineFragmentHeight: CGFloat = 16
...
//        self.lineFragmentTree = LineFragmentTree(
//            rootValue: 0,
//            rootData: rootLineFragmentNodeData,
...
//        let searcher = RedBlackTreeTraversingSearcher(tree: lineFragmentTree)
//        return searcher.search(for: query).compactMap { match in
...
//        } else {
//            let lineFragmentController = lineFragmentControllerFactory.makeLineFragmentController(
//                for: lineFragment,
//                in: line
//            )
