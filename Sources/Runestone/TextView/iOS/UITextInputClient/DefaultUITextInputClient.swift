...
final class DefaultUITextInputClient<
...
>: UITextInputClient {
    ...
    private let textEditingHandler: UITextInputClientTextEditingHandler<StringViewType>
    private let insertionPointHandler: UITextInputClientInsertionPointHandler
    private let navigationHandler: UITextInputClientNavigationHandler<StringViewType, LineManagerType>
    ...
    init(
        ...
        textEditingHandler: UITextInputClientTextEditingHandler<StringViewType>,
        insertionPointHandler: UITextInputClientInsertionPointHandler,
        navigationHandler: UITextInputClientNavigationHandler<StringViewType, LineManagerType>,
...
extension DefaultUITextInputClient {
