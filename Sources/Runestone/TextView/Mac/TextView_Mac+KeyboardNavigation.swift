...
public extension TextView {
    ...
    override func moveBackwardAndModifySelection(_ sender: Any?) {
        selectionNavigator.moveLeftAndModifySelection()
    }
    ...
    override func moveDownAndModifySelection(_ sender: Any?) {
        selectionNavigator.moveDownAndModifySelection()
    }
    ...
    override func moveForwardAndModifySelection(_ sender: Any?) {
        selectionNavigator.moveRightAndModifySelection()
    }
    ...
    override func moveToBeginningOfDocument(_ sender: Any?) {
        locationNavigator.moveToBeginningOfDocument()
    }
    ...
    override func moveWordForwardAndModifySelection(_ sender: Any?) {
        selectionNavigator.moveWordRightAndModifySelection()
    }
