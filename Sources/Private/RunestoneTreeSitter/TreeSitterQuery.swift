...
package enum TreeSitterQueryError: Error {
...
package final class TreeSitterQuery {
    ...
    package init(source: String, language: UnsafePointer<TSLanguage>) throws {
    ...
    package func captureName(forId id: UInt32) -> String {
    ...
    package func predicates(forPatternIndex index: UInt32) -> [TreeSitterPredicate] {
        let lengthPointer = UnsafeMutablePointer<UInt32>.allocate(capacity: 1)
        defer {
            lengthPointer.deallocate()
        }
