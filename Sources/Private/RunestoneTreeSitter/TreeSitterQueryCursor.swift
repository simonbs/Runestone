...
package final class TreeSitterQueryCursor {
    ...
    package func setQueryRange(_ range: ByteRange) {
    ...
    package func validCaptures(in stringView: some TreeSitterStringView) -> [TreeSitterCapture] {
