...
public final class RedBlackTree<NodeID: RedBlackTreeNodeID, NodeValue: RedBlackTreeNodeValue, NodeData> {
    ...
    public func node<T: Comparable & AdditiveArithmetic>(
        ...
        totalValueKeyPath: KeyPath<Node, T>
    ) -> Node? {
    ...
    public func search<T: RedBlackTreeSearchQuery>(using query: T) -> [RedBlackTreeSearchMatch<NodeID, NodeValue, NodeData>]
